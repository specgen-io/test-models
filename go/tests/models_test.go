...
import (
	...
	"github.com/specgen-io/test-models-go/spec"
	"gotest.tools/assert"
	"reflect"
	"testing"
)
...
func TestNumericFields(t *testing.T) {
	...
	var actualData spec.NumericFields
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestNonNumericFields(t *testing.T) {
	...
	var actualData spec.NonNumericFields
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestArrayFields(t *testing.T) {
	...
	var actualData spec.ArrayFields
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestOptionalFields(t *testing.T) {
	...
	var actualData spec.OptionalFields
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestRawJsonField(t *testing.T) {
	...
	var actualData spec.RawJsonField
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestOrderCreated(t *testing.T) {
	...
	var actualData spec.OrderCreated
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestEnumFields(t *testing.T) {
	...
	var actualData spec.EnumFields
	actualJson, err := json.Marshal(data)
	assert.NilError(t, err)
...
func TestOneOfFields(t *testing.T) {
	data := spec.OrderEvent{
		nil,
		&spec.OrderChanged{uuid.MustParse("58d5e212-165b-4ca0-909b-c86b9cee0111"), 3},
		nil,
	}

	jsonStr := `{"changed":{"id":"58d5e212-165b-4ca0-909b-c86b9cee0111","quantity":3}}`

	var actualData spec.OrderEvent
